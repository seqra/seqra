...
<p align="center">
  Opentaint analyzes bytecode of Java and Kotlin web applications (with first-class Spring support) using Semgrep-style YAML rules with CodeQL-grade dataflow to find vulnerabilities that source-only scanners miss.
</p>
