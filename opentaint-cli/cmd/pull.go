...
This prepares the environment with all required dependencies for offline analysis.`,
	Run: func(cmd *cobra.Command, args []string) {
		logrus.Info(formatters.FormatTreeHeader("OpenTaint Pull"))
...
func downloadJava(printer *formatters.TreePrinter) error {
	...
	artefactRoot := fmt.Sprintf("%s/jdk/temurin-%d-jdk-%s-%s", opentaintHome, globals.Config.Java.Version, adoptiumOS, adoptiumArch)
