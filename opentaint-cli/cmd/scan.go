...
import (
	...
	"github.com/seqra/opentaint/internal/container_run"
	"github.com/seqra/opentaint/internal/globals"
	"github.com/seqra/opentaint/internal/load_errors"
...
func scan() {
	...
	if OnlyScan {
		...
		if _, err := os.Stat(absUserProjectRoot + "/project.yaml"); err == nil {
			...
			tempDirName, err = os.MkdirTemp("", "opentaint-*")
			if err != nil {
	...
	if SarifReportPath == "" {
		...
		logrus.Infof("You can view findings by run: opentaint summary --show-findings %s", absSarifReportPath)
