...
class BenchmarkTest : BenchmarkTestBase() {
    ...
    @Test @Timeout(600) fun `benchmark - grpc`() = analyzePkg("grpc", 56, 203, 1089, recursive = true)
    @Test @Timeout(600) fun `benchmark - google-protobuf`() = analyzePkg("google.protobuf", 54, 79, 890, recursive = true)
    @Test @Timeout(600) fun `benchmark - mypy`() = analyzePkg("mypy", 193, 541, 6672, recursive = true)
