...
data class FlatAssign(val target: FlatValue, val source: FlatValue, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitAssign(this)
}
data class FlatLoadAttr(val target: FlatValue, val obj: FlatValue, val attribute: String, val type: FlatType = FlatAnyType, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitLoadAttr(this)
}
data class FlatStoreAttr(val obj: FlatValue, val attribute: String, val value: FlatValue, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitStoreAttr(this)
}
data class FlatLoadSubscript(val target: FlatValue, val obj: FlatValue, val index: FlatValue, val type: FlatType = FlatAnyType, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
...
data class FlatBinOp(val target: FlatValue, val left: FlatValue, val right: FlatValue, val op: FlatBinaryOperator, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitBinOp(this)
}
data class FlatUnaryOp(val target: FlatValue, val operand: FlatValue, val op: FlatUnaryOperator, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitUnaryOp(this)
}
data class FlatCompare(val target: FlatValue, val left: FlatValue, val right: FlatValue, val op: FlatCompareOperator, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitCompare(this)
}

data class FlatCall(val target: FlatValue?, val callee: FlatValue, val args: List<FlatCallArg> = emptyList(), val resolvedCallee: String? = null, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
...
data class FlatBuildList(val target: FlatValue, val elements: List<FlatValue> = emptyList(), override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitBuildList(this)
}
data class FlatBuildTuple(val target: FlatValue, val elements: List<FlatValue> = emptyList(), override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitBuildTuple(this)
}
data class FlatBuildSet(val target: FlatValue, val elements: List<FlatValue> = emptyList(), override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
...
data class FlatGetIter(val target: FlatValue, val iterable: FlatValue, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitGetIter(this)
}
data class FlatNextIter(val target: FlatValue, val iterator: FlatValue, val bodyBlock: Int, val exitBlock: Int, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitNextIter(this)
}
data class FlatUnpack(val targets: List<FlatValue>, val source: FlatValue, val starIndex: Int, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitUnpack(this)
}

data class FlatGoto(val targetBlock: Int, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitGoto(this)
}
data class FlatBranch(val condition: FlatValue, val trueBlock: Int, val falseBlock: Int, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitBranch(this)
}
data class FlatReturn(val value: FlatValue?, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitReturn(this)
}
data class FlatRaise(val exception: FlatValue?, val cause: FlatValue?, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitRaise(this)
}
data class FlatExceptHandler(val target: FlatValue?, val exceptionTypes: List<FlatType>, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitExceptHandler(this)
}

data class FlatYield(val target: FlatValue?, val value: FlatValue?, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitYield(this)
}
data class FlatYieldFrom(val target: FlatValue?, val iterable: FlatValue, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitYieldFrom(this)
}
data class FlatAwait(val target: FlatValue?, val awaitable: FlatValue, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitAwait(this)
}

data class FlatDeleteLocal(val local: FlatValue, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
    override fun <R> accept(visitor: FlatInstVisitor<R>): R = visitor.visitDeleteLocal(this)
}
data class FlatDeleteAttr(val obj: FlatValue, val attribute: String, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
...
data class FlatTypeCheck(val target: FlatValue, val value: FlatValue, val type: FlatType, override val physicalLocation: PIRPhysicalLocation? = null) : FlatInst {
