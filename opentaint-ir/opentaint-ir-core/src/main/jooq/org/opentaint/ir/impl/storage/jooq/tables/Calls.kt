...
open class Calls(
    ...
    override fun getIndexes(): List<Index> = listOf(org.opentaint.ir.impl.storage.jooq.indexes.`CALLS FIELDS`, org.opentaint.ir.impl.storage.jooq.indexes.`CALLS METHODS`)
