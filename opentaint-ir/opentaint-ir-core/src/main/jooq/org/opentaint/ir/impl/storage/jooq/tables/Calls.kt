...
open class Calls(
     ...
     */
    val CALLER_METHOD_OFFSFrontend: TableField<CallsRecord, ByteArray?> = createField(DSL.name("caller_method_offsets"), SQLDataType.BLOB, this, "")
    ...
    override fun getReferences(): List<ForeignKey<CallsRecord, *>> = listOf(
        org.opentaint.ir.impl.storage.jooq.keys.FK_CALLS_SYMBOLS_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_CALLS_BYTECODELOCATIONS_1
    )
    ...
    fun symbols(): Symbols {
        if (!this::_symbols.isInitialized)
            _symbols = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_CALLS_SYMBOLS_1)

        return _symbols;
    }
    fun bytecodelocations(): Bytecodelocations {
        if (!this::_bytecodelocations.isInitialized)
            _bytecodelocations = Bytecodelocations(this, org.opentaint.ir.impl.storage.jooq.keys.FK_CALLS_BYTECODELOCATIONS_1)
