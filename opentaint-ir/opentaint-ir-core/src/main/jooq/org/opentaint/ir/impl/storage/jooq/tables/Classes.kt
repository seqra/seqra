...
open class Classes(
    ...
    override fun getPrimaryKey(): UniqueKey<ClassesRecord> = org.opentaint.ir.impl.storage.jooq.keys.PK_CLASSES
    override fun getKeys(): List<UniqueKey<ClassesRecord>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.PK_CLASSES)
    override fun getReferences(): List<ForeignKey<ClassesRecord, *>> = listOf(
        org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSES_SYMBOLS_2,
        org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSES_BYTECODELOCATIONS_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSES_SYMBOLS_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSES_OUTERCLASSES_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSES_METHODS_1
    )
    ...
    fun fkClassesSymbols_2(): Symbols {
        if (!this::_fkClassesSymbols_2.isInitialized)
            _fkClassesSymbols_2 = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSES_SYMBOLS_2)
    ...
    fun fkClassesSymbols_1(): Symbols {
        if (!this::_fkClassesSymbols_1.isInitialized)
            _fkClassesSymbols_1 = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSES_SYMBOLS_1)

        return _fkClassesSymbols_1;
    }
    fun outerclasses(): Outerclasses {
        if (!this::_outerclasses.isInitialized)
            _outerclasses = Outerclasses(this, org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSES_OUTERCLASSES_1)

        return _outerclasses;
    }
    fun methods(): Methods {
        if (!this::_methods.isInitialized)
            _methods = Methods(this, org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSES_METHODS_1)
