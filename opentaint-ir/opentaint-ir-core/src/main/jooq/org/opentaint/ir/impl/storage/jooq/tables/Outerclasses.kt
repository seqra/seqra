...
open class Outerclasses(
    ...
    override fun getPrimaryKey(): UniqueKey<OuterclassesRecord> = org.opentaint.ir.impl.storage.jooq.keys.PK_OUTERCLASSES
    override fun getKeys(): List<UniqueKey<OuterclassesRecord>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.PK_OUTERCLASSES)
    override fun getReferences(): List<ForeignKey<OuterclassesRecord, *>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.FK_OUTERCLASSES_SYMBOLS_1)

    private lateinit var _symbols: Symbols
    fun symbols(): Symbols {
        if (!this::_symbols.isInitialized)
            _symbols = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_OUTERCLASSES_SYMBOLS_1)
