...
open class Methods(
    ...
    override fun getIndexes(): List<Index> = listOf(org.opentaint.ir.impl.storage.jooq.indexes.METHODS_CLASS_ID_NAME_DESC)
    override fun getPrimaryKey(): UniqueKey<MethodsRecord> = org.opentaint.ir.impl.storage.jooq.keys.PK_METHODS
    override fun getKeys(): List<UniqueKey<MethodsRecord>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.PK_METHODS)
    override fun getReferences(): List<ForeignKey<MethodsRecord, *>> = listOf(
        org.opentaint.ir.impl.storage.jooq.keys.FK_METHODS_SYMBOLS_2,
        org.opentaint.ir.impl.storage.jooq.keys.FK_METHODS_SYMBOLS_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_METHODS_CLASSES_1
    )
    ...
    fun fkMethodsSymbols_2(): Symbols {
        if (!this::_fkMethodsSymbols_2.isInitialized)
            _fkMethodsSymbols_2 = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_METHODS_SYMBOLS_2)

        return _fkMethodsSymbols_2;
    }
    fun fkMethodsSymbols_1(): Symbols {
        if (!this::_fkMethodsSymbols_1.isInitialized)
            _fkMethodsSymbols_1 = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_METHODS_SYMBOLS_1)

        return _fkMethodsSymbols_1;
    }
    fun classes(): Classes {
        if (!this::_classes.isInitialized)
            _classes = Classes(this, org.opentaint.ir.impl.storage.jooq.keys.FK_METHODS_CLASSES_1)
