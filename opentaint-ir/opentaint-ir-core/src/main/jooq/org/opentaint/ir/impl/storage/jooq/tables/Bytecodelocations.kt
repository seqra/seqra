...
open class Bytecodelocations(
    ...
    override fun getIndexes(): List<Index> = listOf(org.opentaint.ir.impl.storage.jooq.indexes.BYTECODELOCATIONS_HASH)
    override fun getPrimaryKey(): UniqueKey<BytecodelocationsRecord> =
        org.opentaint.ir.impl.storage.jooq.keys.PK_BYTECODELOCATIONS
    override fun getKeys(): List<UniqueKey<BytecodelocationsRecord>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.PK_BYTECODELOCATIONS)
    override fun getReferences(): List<ForeignKey<BytecodelocationsRecord, *>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.FK_BYTECODELOCATIONS_BYTECODELOCATIONS_1)
    ...
    fun bytecodelocations(): Bytecodelocations {
        if (!this::_bytecodelocations.isInitialized)
            _bytecodelocations = Bytecodelocations(this,
                org.opentaint.ir.impl.storage.jooq.keys.FK_BYTECODELOCATIONS_BYTECODELOCATIONS_1
            )
