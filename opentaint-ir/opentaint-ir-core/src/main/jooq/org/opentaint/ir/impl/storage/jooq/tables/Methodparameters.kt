...
open class Methodparameters(
    ...
    override fun getPrimaryKey(): UniqueKey<MethodparametersRecord> =
        org.opentaint.ir.impl.storage.jooq.keys.PK_METHODPARAMETERS
    override fun getKeys(): List<UniqueKey<MethodparametersRecord>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.PK_METHODPARAMETERS)
    override fun getReferences(): List<ForeignKey<MethodparametersRecord, *>> = listOf(
        org.opentaint.ir.impl.storage.jooq.keys.FK_METHODPARAMETERS_SYMBOLS_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_METHODPARAMETERS_METHODS_1
    )
    ...
    fun symbols(): Symbols {
        if (!this::_symbols.isInitialized)
            _symbols = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_METHODPARAMETERS_SYMBOLS_1)

        return _symbols;
    }
    fun methods(): Methods {
        if (!this::_methods.isInitialized)
            _methods = Methods(this, org.opentaint.ir.impl.storage.jooq.keys.FK_METHODPARAMETERS_METHODS_1)
