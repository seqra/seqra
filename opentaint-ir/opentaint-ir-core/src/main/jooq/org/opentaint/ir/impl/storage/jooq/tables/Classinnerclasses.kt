...
open class Classinnerclasses(
    ...
    override fun getPrimaryKey(): UniqueKey<ClassinnerclassesRecord> =
        org.opentaint.ir.impl.storage.jooq.keys.PK_CLASSINNERCLASSES
    override fun getKeys(): List<UniqueKey<ClassinnerclassesRecord>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.PK_CLASSINNERCLASSES)
    override fun getReferences(): List<ForeignKey<ClassinnerclassesRecord, *>> = listOf(
        org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSINNERCLASSES_CLASSES_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSINNERCLASSES_SYMBOLS_1
    )
    ...
    fun classes(): Classes {
        if (!this::_classes.isInitialized)
            _classes = Classes(this, org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSINNERCLASSES_CLASSES_1)

        return _classes;
    }
    fun symbols(): Symbols {
        if (!this::_symbols.isInitialized)
            _symbols = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_CLASSINNERCLASSES_SYMBOLS_1)
