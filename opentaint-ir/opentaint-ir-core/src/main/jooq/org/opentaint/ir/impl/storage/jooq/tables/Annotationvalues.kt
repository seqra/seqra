...
open class Annotationvalues(
    ...
    override fun getPrimaryKey(): UniqueKey<AnnotationvaluesRecord> =
        org.opentaint.ir.impl.storage.jooq.keys.PK_ANNOTATIONVALUES
    override fun getKeys(): List<UniqueKey<AnnotationvaluesRecord>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.PK_ANNOTATIONVALUES)
    override fun getReferences(): List<ForeignKey<AnnotationvaluesRecord, *>> = listOf(
        org.opentaint.ir.impl.storage.jooq.keys.FK_ANNOTATIONVALUES_ANNOTATIONS_2,
        org.opentaint.ir.impl.storage.jooq.keys.FK_ANNOTATIONVALUES_ANNOTATIONS_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_ANNOTATIONVALUES_SYMBOLS_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_ANNOTATIONVALUES_SYMBOLS_2
    )

    private lateinit var _fkAnnotationvaluesAnnotations_2: org.opentaint.ir.impl.storage.jooq.tables.Annotations
    private lateinit var _fkAnnotationvaluesAnnotations_1: org.opentaint.ir.impl.storage.jooq.tables.Annotations
    private lateinit var _fkAnnotationvaluesSymbols_1: Symbols
    private lateinit var _fkAnnotationvaluesSymbols_2: Symbols
    fun fkAnnotationvaluesAnnotations_2(): org.opentaint.ir.impl.storage.jooq.tables.Annotations {
        if (!this::_fkAnnotationvaluesAnnotations_2.isInitialized)
            _fkAnnotationvaluesAnnotations_2 = org.opentaint.ir.impl.storage.jooq.tables.Annotations(
                this,
                org.opentaint.ir.impl.storage.jooq.keys.FK_ANNOTATIONVALUES_ANNOTATIONS_2
            )
    ...
    fun fkAnnotationvaluesAnnotations_1(): org.opentaint.ir.impl.storage.jooq.tables.Annotations {
        if (!this::_fkAnnotationvaluesAnnotations_1.isInitialized)
            _fkAnnotationvaluesAnnotations_1 = org.opentaint.ir.impl.storage.jooq.tables.Annotations(
                this,
                org.opentaint.ir.impl.storage.jooq.keys.FK_ANNOTATIONVALUES_ANNOTATIONS_1
            )
