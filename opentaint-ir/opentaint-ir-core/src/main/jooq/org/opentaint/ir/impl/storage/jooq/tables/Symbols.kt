...
open class Symbols(
    ...
    override fun getIndexes(): List<Index> = listOf(org.opentaint.ir.impl.storage.jooq.indexes.SYMBOLS_NAME)
    override fun getPrimaryKey(): UniqueKey<SymbolsRecord> = org.opentaint.ir.impl.storage.jooq.keys.PK_SYMBOLS
    override fun getKeys(): List<UniqueKey<SymbolsRecord>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.PK_SYMBOLS)
