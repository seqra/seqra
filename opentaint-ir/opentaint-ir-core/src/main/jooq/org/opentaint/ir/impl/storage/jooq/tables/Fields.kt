...
open class Fields(
    ...
    override fun getIndexes(): List<Index> = listOf(org.opentaint.ir.impl.storage.jooq.indexes.FIELDS_CLASS_ID_NAME)
    override fun getPrimaryKey(): UniqueKey<FieldsRecord> = org.opentaint.ir.impl.storage.jooq.keys.PK_FIELDS
    override fun getKeys(): List<UniqueKey<FieldsRecord>> = listOf(org.opentaint.ir.impl.storage.jooq.keys.PK_FIELDS)
    override fun getReferences(): List<ForeignKey<FieldsRecord, *>> = listOf(
        org.opentaint.ir.impl.storage.jooq.keys.FK_FIELDS_SYMBOLS_2,
        org.opentaint.ir.impl.storage.jooq.keys.FK_FIELDS_SYMBOLS_1,
        org.opentaint.ir.impl.storage.jooq.keys.FK_FIELDS_CLASSES_1
    )
    ...
    fun fkFieldsSymbols_2(): Symbols {
        if (!this::_fkFieldsSymbols_2.isInitialized)
            _fkFieldsSymbols_2 = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_FIELDS_SYMBOLS_2)

        return _fkFieldsSymbols_2;
    }
    fun fkFieldsSymbols_1(): Symbols {
        if (!this::_fkFieldsSymbols_1.isInitialized)
            _fkFieldsSymbols_1 = Symbols(this, org.opentaint.ir.impl.storage.jooq.keys.FK_FIELDS_SYMBOLS_1)

        return _fkFieldsSymbols_1;
    }
    fun classes(): Classes {
        if (!this::_classes.isInitialized)
            _classes = Classes(this, org.opentaint.ir.impl.storage.jooq.keys.FK_FIELDS_CLASSES_1)
