 ...
 */
open class JIRExceptionResolver(val classpath: JIRProject) : DefaultJIRExprVisitor<List<JIRClassType>>,
    ...
    override fun visitJIRCastExpr(expr: JIRCastExpr): List<JIRClassType> {
        return when {
            PredefinedJIRPrimitives.matches(expr.type.typeName) -> emptyList()
