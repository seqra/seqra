...
import org.opentaint.opentaint-ir.api.JIRDBSymbolsInterner
import org.opentaint.opentaint-ir.api.RegisteredLocation
import org.opentaint.opentaint-ir.impl.storage.jooq.tables.references.ANNOTATIONS
import org.opentaint.opentaint-ir.impl.storage.jooq.tables.references.ANNOTATIONVALUES
...
import org.opentaint.opentaint-ir.impl.storage.jooq.tables.references.CLASSINNERCLASSES
...
import org.opentaint.opentaint-ir.impl.storage.jooq.tables.references.OUTERCLASSES
...
class PersistenceService(private val persistence: SQLitePersistenceImpl) {
    ...
    fun newSymbolInterner() = JIRDBSymbolsInternerImpl(jooq = persistence.jooq, symbolsIdGen, symbolsCache)
...
class JIRDBSymbolsInternerImpl(
    override val jooq: DSLContext,
    private val symbolsIdGen: AtomicLong,
    private val symbolsCache: ConcurrentHashMap<String, Long>
) : JIRDBSymbolsInterner {
