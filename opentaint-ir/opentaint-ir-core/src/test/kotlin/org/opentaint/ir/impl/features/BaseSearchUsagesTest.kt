...
abstract class BaseSearchUsagesTest : BaseTest() {
    ...
    fun `classes read fields`() {
        val usages = fieldsUsages<org.opentaint.opentaint-ir.impl.usages.fields.FieldA>(FieldUsageMode.READ)
        assertEquals(
            sortedMapOf(
                "a" to setOf(
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldA#<init>",
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldA#isPositive",
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldA#useCPrivate",
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldAImpl#hello"
                ),
                "b" to setOf(
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldA#isPositive",
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldA#useA",
                ),
                "fieldB" to setOf(
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldA#useCPrivate",
                )
    ...
    fun `classes write fields`() {
        val usages = fieldsUsages<org.opentaint.opentaint-ir.impl.usages.fields.FieldA>()
        assertEquals(
            sortedMapOf(
                "a" to setOf(
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldA#<init>",
    ...
    fun `classes write fields coupled`() {
        val usages = fieldsUsages<org.opentaint.opentaint-ir.impl.usages.fields.FieldB>()
        assertEquals(
            sortedMapOf(
                "c" to setOf(
                    "org.opentaint.opentaint-ir.impl.usages.fields.FakeFieldA#useCPrivate",
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldA#useCPrivate",
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldB#<init>",
                    "org.opentaint.opentaint-ir.impl.usages.fields.FieldB#useCPrivate",
                )
            ),
            usages
        )
    ...
    fun `classes methods usages`() {
        val usages = methodsUsages<org.opentaint.opentaint-ir.impl.usages.methods.MethodA>()
        assertEquals(
            sortedMapOf(
                "<init>" to setOf(
                    "org.opentaint.opentaint-ir.impl.usages.methods.MethodB#hoho",
                    "org.opentaint.opentaint-ir.impl.usages.methods.MethodC#<init>"
                ),
                "hello" to setOf(
                    "org.opentaint.opentaint-ir.impl.usages.methods.MethodB#hoho",
                    "org.opentaint.opentaint-ir.impl.usages.methods.MethodC#hello",
                )
            ),
            usages
        )
