...
class IRTest : BaseTest() {
    ...
    fun `get ir of simple method`() {
        testClass(cp.findClass<org.opentaint.ir.impl.cfg.IRExamples>())
    }

    @Test
    fun `get ir of algorithms lesson 1`() {
        testClass(cp.findClass<org.opentaint.ir.impl.cfg.JavaTasks>())
    }

    @Test
    fun `get ir of binary search tree`() {
        testClass(cp.findClass<org.opentaint.ir.impl.cfg.BinarySearchTree<*>>())
        testClass(cp.findClass<org.opentaint.ir.impl.cfg.BinarySearchTree<*>.BinarySearchTreeIterator>())
    }
