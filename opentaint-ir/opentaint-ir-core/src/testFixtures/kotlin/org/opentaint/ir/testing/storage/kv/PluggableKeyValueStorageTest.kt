...
import org.opentaint.ir.api.jvm.storage.kv.asIterable
...
abstract class PluggableKeyValueStorageTest {
    ...
    private lateinit var storage: PluggableKeyValueStorage
...
private val String.asByteArray: ByteArray
    get() =
        BuiltInBindingProvider.getBinding(String::class.java).getBytes(this)

private val ByteArray.asString: String
    get() =
        BuiltInBindingProvider.getBinding(String::class.java).getObject(this)