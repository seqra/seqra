 ...
 * - communication between different runners, i.e. they should submit received
 *   [EdgeForOtherRunnerQuery] to proper runners via [IfdsUnitRunner.submitNewEdge] call
 ...
 */
data class SubscriptionForSummaryEdges(
    val method: JIRMethod,
    val collector: FlowCollector<IfdsEdge>,
) : IfdsUnitRunnerEvent
