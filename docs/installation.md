...
| Platform | Download |
|----------|----------|
| Linux x64 | [seqra_linux_amd64.tar.gz](https://github.com/seqra/opentaint/releases/latest/download/seqra_linux_amd64.tar.gz) |
| Linux ARM64 | [seqra_linux_arm64.tar.gz](https://github.com/seqra/opentaint/releases/latest/download/seqra_linux_arm64.tar.gz) |
| macOS x64 | [seqra_darwin_amd64.tar.gz](https://github.com/seqra/opentaint/releases/latest/download/seqra_darwin_amd64.tar.gz) |
| macOS ARM64 (Apple Silicon) | [seqra_darwin_arm64.tar.gz](https://github.com/seqra/opentaint/releases/latest/download/seqra_darwin_arm64.tar.gz) |
| Windows x64 | [seqra_windows_amd64.zip](https://github.com/seqra/opentaint/releases/latest/download/seqra_windows_amd64.zip) |
| Windows ARM64 | [seqra_windows_arm64.zip](https://github.com/seqra/opentaint/releases/latest/download/seqra_windows_arm64.zip) |

### Linux/macOS Installation

```bash
mkdir opentaint && cd opentaint
curl -L https://github.com/seqra/opentaint/releases/latest/download/seqra_linux_amd64.tar.gz -o seqra.tar.gz
tar -xzf seqra.tar.gz opentaint && rm seqra.tar.gz
...
First-time `opentaint scan` will also download these automatically.
